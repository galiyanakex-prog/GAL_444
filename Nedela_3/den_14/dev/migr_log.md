...
> Чистка журнала (дебаг Дня 14, этап D5, `debug_plan_5.md`): удалены черновые
> заглушки и дубль «Этапа 0» (блок «Подшаги Этапа 0» + оборванная строка
> «**Найдено расхождений:» + заглушка «Этап 1 — ...»), предшествовавшие записям
> M0–M8. Факты этапов M0–M8 и «Итог миграции» не изменялись.

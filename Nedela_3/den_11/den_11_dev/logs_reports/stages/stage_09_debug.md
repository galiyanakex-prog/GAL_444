...
|---|---|---|---|
| L1 | `$PY -m py_compile den_11_Kod.py core/*.py memory/*.py storage/*.py` | 0 | без правок (Этап 8) |
...
(README_d11.md, den_11_run.sh/.desktop, Проверка_Д11.md, check_acceptance.sh,
final_report.md).
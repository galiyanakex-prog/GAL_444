...
class Agent:
    ...
    def _compress_history(self, old_messages, summary):
        ...
        # Лимит в словах (self.summary_word_limit) формулируется именно в промпте —
        # так он реально ограничивает текст, а не обрезает ответ постфактум.
        system_prompt = COMPRESS_PROMPT.format(
    ...
    def save_history(self, filepath: str):
        ...
        with open(filepath, "w", encoding="utf-8") as f:
            ...
            f.write(
                f"# Лог диалога — День 9 (контекст={self.context_strategy}, "
    ...
    def load_context_json(self, filepath: str):
        ...
        try:
            ...
            # недостающие поля (v1 — usage, v2 — настройки сжатия Дня 9) подставляются
...
print("Команды: /history /window /summary /compress [on|off] /compare /layers /layer "
      "/save /load /tokens /cost /scenario /clear /exit")
